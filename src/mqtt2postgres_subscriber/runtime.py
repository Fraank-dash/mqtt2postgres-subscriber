...
from mqtt2postgres_subscriber.client import create_subscriber_client, topic_matches
from mqtt2postgres_subscriber.models import EventEmitter, SubscriberSettings
...
class DatabaseFunctionWriter:
    ...
    @classmethod
    def from_config(cls, *, config: SubscriberSettings) -> "DatabaseFunctionWriter":
...
class MQTTToPostgresService:
    ...
    writer_factory: type[DatabaseFunctionWriter] | Any = DatabaseFunctionWriter.from_config
    mqtt_client_factory: Any = create_subscriber_client
